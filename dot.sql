...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2019 at 04:19 PM
...
CREATE TABLE `pegawai` (
  ...
  `kd_departemen` varchar(225) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pegawai` (`id`, `nama`, `com`, `em`, `kd_departemen`) VALUES
(1, 'fad', 'dot', 'SPPRBM0001', 'BDPRBM00001');
